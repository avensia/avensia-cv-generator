/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env dev --env-interface CloudflareEnv src/types/cloudflare-env.d.ts` (hash: 3b2d5dca932b5b94cd0b5d22f65fcefb)
